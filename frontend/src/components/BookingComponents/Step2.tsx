                    ...
                    <div className="bg-[#111111] border border-white/5 p-8 rounded-xl shadow-inner">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button
                                ...
                                className="btn-gradient flex-1 px-8 py-3.5 rounded-xl text-white font-bold text-base hover:scale-[1.02] transition-transform active:scale-[0.98] shadow-lg shadow-primary/20 disabled:opacity-60 disabled:pointer-events-none disabled:scale-100 flex items-center justify-center gap-2"
                            >
                                {isSubmitting ? (
                                    <>
                ...
                <form className="space-y-6" onSubmit={handleScheduleEvent}>
                    <div className="space-y-4">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                className="w-full bg-[#171717] border border-white/5 rounded-lg px-4 py-3 text-white placeholder:text-[#9ca3af]/50 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all shadow-inner"
                                id="name"
                    ...
                    <div className="flex flex-col gap-1.5 pt-4">
                        <label className="font-label text-sm font-semibold text-white opacity-50" htmlFor="notes">
                            Please share anything that will help prepare for our meeting
                        </label>
                        <textarea
                            disabled
                            className="w-full bg-[#171717] border border-white/5 rounded-lg px-4 py-3 text-white placeholder:text-[#9ca3af]/30 focus:outline-none transition-all shadow-inner resize-none opacity-50 cursor-not-allowed"
                            id="notes"
                            placeholder="Notes currently disabled..."
                            rows={4}
                        />
                    </div>
                    ...
                    <div className="pt-6">
                        <button
                            className="btn-gradient w-full md:w-auto px-8 py-3.5 rounded-xl text-white font-bold text-base hover:scale-[1.02] transition-transform active:scale-[0.98] disabled:opacity-60 disabled:pointer-events-none disabled:scale-100 flex items-center gap-2"
                            type="submit"
                            disabled={isSubmitting}
                        >
                            {isSubmitting ? (
