                ...
                <div className="p-8 space-y-8">
                    <div className="relative">
                        ...
                        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                            <PopoverTrigger className="w-full h-14 glass-card px-5 rounded-xl flex items-center justify-between transition-all border border-primary/30 shadow-[0_0_15px_rgba(124,58,237,0.1)] group cursor-pointer text-left">
                                ...
                                <span className="material-symbols-outlined text-[#a79db9] transition-transform -180">expand_more</span>
                            </PopoverTrigger>
                    ...
                    <div>
                        ...
                        <label className="w-full h-14 glass-card px-5 rounded-xl flex items-center gap-3 border border-white/5 transition-all text-white focus-within:ring-2 focus-within:ring-blue-500/50 cursor-text">
                    ...
                    <div>
                        ...
                        <label className="w-full h-14 glass-card px-5 rounded-xl flex items-center gap-3 border border-white/5 transition-all text-white focus-within:ring-2 focus-within:ring-blue-500/50 cursor-pointer relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                        ...
                        <div className="space-y-3 relative">
                            ...
                            <label className={`w-full h-14 glass-card px-5 rounded-xl flex items-center gap-3 border ${hasTimeError() ? 'border-red-500/50 bg-red-500/10 focus-within:ring-red-500/50' : 'border-white/5 focus-within:ring-primary/50'} transition-all text-white focus-within:ring-2 cursor-text`}>
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="w-full h-16 bg-linear- -500 rounded-xl font-body font-black text-xl tracking-tight text-white shadow-[0_10px_40px_rgba(124,58,237,0.3)] hover:scale-[1.02] disabled:opacity-50 disabled:pointer-events-none disabled:saturate-50 transition-all flex items-center justify-center gap-3"
                        >
