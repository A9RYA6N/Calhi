            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-16">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        <a className="text-sm font-medium text-gray-300 transition-colors" href="#">Features</a>
                        <a className="text-sm font-medium text-gray-300 transition-colors" href="#">Use Cases</a>
                        <a className="text-sm font-medium text-gray-300 transition-colors" href="#">Pricing</a>
                    </div>
                    {/* CTA */}
                    <div className="flex items-center gap-4">
                        <a className="text-sm font-medium text-white transition-colors hidden sm:block cursor-pointer" onClick={() => navigate("/login")}>Log in</a>
