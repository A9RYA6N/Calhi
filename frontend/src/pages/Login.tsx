                    ...
                    <div className="glass-card p-10 rounded-2xl shadow-2xl">
                        ...
                        <form className="space-y-6" onSubmit={handleLogin}>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <a className="text-[10px] font-bold uppercase tracking-widest text-primary transition-colors" href="#">Forgot Password?</a>
                                </div>
                                <div className="relative group">
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <span className="material-symbols-outlined absolute right-4 top-4 text-gray-600 group-focus-within:text-primary transition-colors cursor-pointer ">visibility</span>
                                </div>
                            </div>
                            <button
                                className="w-full btn-gradient text-white font-bold py-4 rounded-xl transition-all active:scale-[0.98] flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                type="submit"
                                disabled={isLoading}
                            >
                            ...
                            <button
                                ...
                                className="w-full bg-[#171717] border border-white/5 text-gray-300 font-bold py-3.5 rounded-xl transition-all active:scale-[0.98] flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
                                disabled={isLoading}
                            >
                        ...
                        <div className="mt-8 pt-8 border-t border-white/5 text-center">
                            <p className="text-sm text-gray-400">
                                Don't have an account? <Link className="text-white font-bold transition-colors underline-offset-4 underline" to="/register">Register</Link>
                            </p>
                        </div>
                    </div>
                </div>
